...
import com.inventario.licoreria.modules.users.dto.UpdatePasswordDTO;
...
public class UserController {
    ...
    @PutMapping("/username")
    public ResponseEntity<UserResponseDTO> updateUsername(@Valid @RequestBody UpdateUserDTO dto, Authentication authentication) {
        Objects.requireNonNull(authentication, "authentication no puede ser null");
        String username = Objects.requireNonNull(authentication.getName(), "username no puede ser null");
        User user = Objects.requireNonNull(userService.findByUsername(username), "Usuario no encontrado");
        Long userId = Objects.requireNonNull(user.getId(), "id de usuario no puede ser null");
    ...
    @PutMapping("/password")
    public ResponseEntity<UserResponseDTO> updatePassword(@Valid @RequestBody UpdatePasswordDTO dto, Authentication authentication) {
        try {
            Objects.requireNonNull(authentication, "authentication no puede ser null");
            String username = Objects.requireNonNull(authentication.getName(), "username no puede ser null");
            User user = Objects.requireNonNull(userService.findByUsername(username), "Usuario no encontrado");
            Long userId = Objects.requireNonNull(user.getId(), "id de usuario no puede ser null");
            String oldPassword = Objects.requireNonNull(dto.getOldPassword(), "oldPassword no puede ser null");
            String newPassword = Objects.requireNonNull(dto.getNewPassword(), "newPassword no puede ser null");
